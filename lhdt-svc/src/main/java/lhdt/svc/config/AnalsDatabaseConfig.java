...
@Slf4j
@Configuration
@MapperScan(value="lhdt.svc", annotationClass = AnalsConnMapper.class, sqlSessionFactoryRef = "analsSqlSessionFactory")
...
//	}
	...
	public SqlSessionFactory analsSqlSessionFactory(@Qualifier("dataSource") DataSource dataSource, ApplicationContext context) throws Exception{
		...
		//
		sqlSessionFactoryBean.setMapperLocations(context.getResources("classpath*:mybatis/svc/**/*.xml"));
