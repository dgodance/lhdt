...
public class CmmnController {
	 ...
	 * @return
	 */
	protected <T extends CmmnDomain> ResponseEntity<Map<String,Object>> res(List<T> list){
	 ...
	 * @return
	 */
	protected <T extends CmmnDomain> ResponseEntity<Map<String,Object>> res(List<T> list, HttpStatus hs){
