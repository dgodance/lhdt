...
public final class DSPaginator {
    public static DSPaginatorInfo getPaginatorMap(Page<?> page, DSPageSize DSPageSize) {
        ...
        DSPaginatorInfo pageNav = new DSPaginatorInfo();
