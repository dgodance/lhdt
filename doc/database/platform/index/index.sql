...
create index design_layer_land_idx on design_layer_land (design_layer_land_id);
create index design_layer_land_geom_idx on design_layer_land using gist (the_geom);
create index design_layer_building_idx on design_layer_building (design_layer_building_id);
