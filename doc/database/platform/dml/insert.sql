...
values
	...
	(32, '0', '1', '데이터 그룹 등록', 'DATA', 3, 3, 2, 2, 2, '/data-group/input', '/data-group/list', null, 'glyph-monitor', 'N', 'Y', 'N'),
	...
	(52, '0', '1', '2D 레이어 그룹 등록', 'LAYER', 5, 5, 2, 2, 2, '/layer-group/input', '/layer-group/list', null, 'glyph-check', 'N', 'Y', 'N'),
	...
	(55, '0', '1', '2D 레이어 등록', 'LAYER', 5, 5, 2, 2, 5, '/layer/input', '/layer/list', null, 'glyph-check', 'N', 'Y', 'N'),
	(56, '0', '1', '2D 레이어 수정', 'LAYER', 5, 5, 2, 2, 6, '/layer/modify', '/layer/list', null, 'glyph-check', 'N', 'Y', 'N'),
	(6, '0', '1', 'Extrusion Model', 'EXTRUSION MODEL', 6, 0, 1, 2, 6, '/design-layer/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(61, '0', '1', '도시 그룹', 'EXTRUSION MODEL', 6, 6, 2, 1, 1, '/urban-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(62, '0', '1', '도시 그룹 등록', 'EXTRUSION MODEL', 6, 6, 2, 2, 2, '/urban-group/input', '/urban-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(63, '0', '1', '도시 그룹 수정', 'EXTRUSION MODEL', 6, 6, 2, 2, 3, '/urban-group/modify', '/urban-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(64, '0', '1', '디자인 레이어 그룹', 'EXTRUSION MODEL', 6, 6, 2, 2, 4, '/design-layer-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(65, '0', '1', '디자인 레이어 그룹 등록', 'EXTRUSION MODEL', 6, 6, 2, 2, 5, '/design-layer-group/input', '/design-layer-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(66, '0', '1', '디자인 레이어 그룹 수정', 'EXTRUSION MODEL', 6, 6, 2, 2, 6, '/design-layer-group/modify', '/design-layer-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(67, '0', '1', '디자인 레이어 목록', 'EXTRUSION MODEL', 6, 6, 2, 2, 7, '/design-layer/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(68, '0', '1', '디자인 레이어 등록', 'EXTRUSION MODEL', 6, 6, 2, 2, 8, '/design-layer/input', '/design-layer/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(69, '0', '1', '디자인 레이어 수정', 'EXTRUSION MODEL', 6, 6, 2, 2, 9, '/design-layer/modify', '/design-layer/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(70, '0', '1', '데이터 라이브러리 그룹', 'EXTRUSION MODEL', 6, 6, 2, 2, 10, '/data-library-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(71, '0', '1', '데이터 라이브러리 그룹 등록', 'EXTRUSION MODEL', 6, 6, 2, 2, 11, '/data-library-group/input', '/data-library-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(72, '0', '1', '데이터 라이브러리 그룹 수정', 'EXTRUSION MODEL', 6, 6, 2, 2, 12, '/data-library-group/modify', '/data-library-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(73, '0', '1', '데이터 라이브러리 업로드', 'DATA', 6, 6, 2, 2, 13, '/data-library-upload/input', null, null, 'glyph-monitor', 'Y', 'Y', 'Y'),
	(74, '0', '1', '데이터 라이브러리 업로드 목록', 'DATA', 6, 6, 2, 2, 14, '/data-library-upload/list', null, null, 'glyph-monitor', 'Y', 'Y', 'Y'),
	(75, '0', '1', '데이터 라이브러리 업로드 수정', 'DATA', 6, 6, 2, 2, 15, '/data-library-upload/modify', '/data-library-upload/list', null, 'glyph-monitor', 'N', 'Y', 'N'),
	(76, '0', '1', '데이터 라이브러리 변환 결과', 'DATA', 6, 6, 2, 2, 16, '/data-library-converter/list', null, null, 'glyph-monitor', 'Y', 'Y', 'Y'),
	(77, '0', '1', '데이터 라이브러리 목록', 'EXTRUSION MODEL', 6, 6, 2, 2, 17, '/data-library/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(78, '0', '1', '데이터 라이브러리 수정', 'EXTRUSION MODEL', 6, 6, 2, 2, 18, '/data-library/modify', '/data-library/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(8, '0', '1', '디지털트윈 서비스', 'DIGITALTWIN SERVICE', 8, 0, 1, 2, 8, '/micro-service/list', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(81, '0', '1', '디지털트윈 서비스 목록', 'DIGITALTWIN SERVICE', 8, 8, 2, 1, 1, '/micro-service/list', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(82, '0', '1', '디지털트윈 서비스 등록', 'DIGITALTWIN SERVICE', 8, 8, 2, 2, 2, '/micro-service/input', '/micro-service/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(83, '0', '1', '디지털트윈 서비스 수정', 'DIGITALTWIN SERVICE', 8, 8, 2, 2, 3, '/micro-service/modify', '/micro-service/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(9, '0', '1', '환경설정', 'CONFIGURATION', 9, 0, 1, 2, 9, '/policy/modify', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(91, '0', '1', '일반 운영정책', 'CONFIGURATION', 9, 9, 2, 1, 1, '/policy/modify', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(92, '0', '1', '공간정보 운영정책', 'CONFIGURATION', 9, 9, 2, 2, 2, '/geopolicy/modify', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(93, '0', '1', '관리자 메뉴', 'ADMIN MENU', 9, 9, 2, 2, 3, '/menu/admin-menu', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
	(94, '0', '1', '사용자 메뉴', 'USER MENU', 9, 9, 2, 2, 4, '/menu/user-menu', null, null, 'glyph-settings', 'Y', 'Y', 'Y'),
...
values
    ...
    /*(1103, '1', '0', 'Extrusion', 'EXTRUSION', 1103, 0, 1, 1, 7, '/extrusion', null, 'extrusionMenu', 'extrusionContent', 'extrusion', 'Y', 'Y', 'Y'),*/
    (1104, '1', '0', '레이어', 'LAYER', 1104, 0, 1, 1, 8, '/layer/list', null, 'layerMenu', 'layerContent', 'layer', 'Y', 'Y', 'Y'),
    /*(1105, '1', '0', '사물인터넷', 'IOT', 1105, 0, 1, 1, 9, '/iot/windy', null, 'iotMenu', 'iotContent', 'iot', 'Y', 'Y', 'Y'),*/
    (1106, '1', '0', '환경설정', 'USER POLICY', 1106, 0, 1, 1, 10, '/user-policy/modify', null, 'userPolicyMenu', 'userPolicyContent', 'userPolicy', 'Y', 'Y', 'Y');
