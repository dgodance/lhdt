...
values
	...
	(6, '0', '1', 'Extrusion Model', 'EXTRUSION MODEL', 6, 0, 1, 6, '/extrusion-model/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(61, '0', '1', 'Extrusion Model 그룹', 'EXTRUSION MODEL', 6, 6, 2, 1, '/extrusion-model-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(62, '0', '1', 'Extrusion Model 그룹 등록', 'EXTRUSION MODEL', 6, 6, 2, 2, '/extrusion-model-group/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(63, '0', '1', 'Extrusion Model 그룹 수정', 'EXTRUSION MODEL', 6, 6, 2, 3, '/extrusion-model-group/modify', '/extrusion-model-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(64, '0', '1', 'Extrusion Model 목록', 'EXTRUSION MODEL', 6, 6, 2, 4, '/extrusion-model/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(65, '0', '1', 'Extrusion Model 등록', 'EXTRUSION MODEL', 6, 6, 2, 5, '/extrusion-model/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(66, '0', '1', 'Extrusion Model 수정', 'EXTRUSION MODEL', 6, 6, 2, 6, '/extrusion-model/modify', '/extrusion-model/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(67, '0', '1', 'Data Library 그룹', 'Data Library', 6, 6, 2, 7, '/data-library-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(68, '0', '1', 'Data Library 그룹 등록', 'Data Library', 6, 6, 2, 8, '/data-library-group/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(69, '0', '1', 'Data Library 그룹 수정', 'Data Library', 6, 6, 2, 9, '/data-library-group/modify', '/data-library-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(70, '0', '1', 'Data Library 목록', 'Data Library', 6, 6, 2, 10, '/data-library/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(71, '0', '1', 'Data Library 등록', 'Data Library', 6, 6, 2, 11, '/data-library/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(72, '0', '1', 'Data Library 수정', 'Data Library', 6, 6, 2, 12, '/data-library/modify', '/data-library/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
