...
values
	...
	(6, '0', '1', '디자인 레이어', 'DESIGN LAYER', 6, 0, 1, 6, '/extrusion-model/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(61, '0', '1', '디자인 레이어 그룹', 'DESIGN LAYER', 6, 6, 2, 1, '/design-layer-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(62, '0', '1', '디자인 레이어 그룹 등록', 'DESIGN LAYER', 6, 6, 2, 2, '/design-layer-group/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(63, '0', '1', '디자인 레이어 그룹 수정', 'DESIGN LAYER', 6, 6, 2, 3, '/design-layer-group/modify', '/design-layer-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(64, '0', '1', '디자인 레이어 목록', 'DESIGN LAYER', 6, 6, 2, 4, '/design-layer/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(65, '0', '1', '디자인 레이어 등록', 'DESIGN LAYER', 6, 6, 2, 5, '/design-layer/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(66, '0', '1', '디자인 레이어 수정', 'DESIGN LAYER', 6, 6, 2, 6, '/design-layer/modify', '/design-layer/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(67, '0', '1', '데이터 라이브러리 그룹', 'Data Library', 6, 6, 2, 7, '/data-library-group/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(68, '0', '1', '데이터 라이브러리 그룹 등록', 'Data Library', 6, 6, 2, 8, '/data-library-group/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(69, '0', '1', '데이터 라이브러리 그룹 수정', 'Data Library', 6, 6, 2, 9, '/data-library-group/modify', '/data-library-group/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
	(70, '0', '1', '데이터 라이브러리 목록', 'Data Library', 6, 6, 2, 10, '/data-library/list', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(71, '0', '1', '데이터 라이브러리 등록', 'Data Library', 6, 6, 2, 11, '/data-library/input', null, null, 'glyph-desktop', 'Y', 'Y', 'Y'),
	(72, '0', '1', '데이터 라이브러리 수정', 'Data Library', 6, 6, 2, 12, '/data-library/modify', '/data-library/list', null, 'glyph-desktop', 'N', 'Y', 'N'),
