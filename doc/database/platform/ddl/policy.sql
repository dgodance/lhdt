...
create table policy(
	...
	board_upload_type						varchar(256)		default 'txt,pdf,hwp,xlsx,docs,zip,png,jpg,jpeg',
...
comment on column policy.board_upload_type is '업로딩 가능 확장자. txt,pdf,hwp,xlsx,docs,zip,png,jpg,jpeg';
