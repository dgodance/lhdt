...
create table design_layer_land (
    ...
    building_use_defined                        varchar(100),
    building_use_recommended                    varchar(100),
    building_use_allowed                        varchar(100),
    building_use_conditional                    varchar(100),
    building_use_forbidden                      varchar(100),
