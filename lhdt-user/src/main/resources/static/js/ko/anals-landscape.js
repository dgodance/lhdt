...
const PREDICT_SERVER_URL = 'http://118.42.112.206:8090/svc/landscape_anals/uploadFileAndGetSkylineImage';
...
SkylineObj.prototype.saveAllImages = function(){
	...
	//
	let url = 'http://118.42.112.206:8090/svc/landscape_anals/saveCaptureAndSkylineImages';
	let fd = new FormData();
