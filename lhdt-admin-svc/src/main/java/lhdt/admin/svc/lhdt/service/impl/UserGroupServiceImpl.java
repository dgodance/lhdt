...
import lhdt.admin.svc.lhdt.domain.Depth;
import lhdt.admin.svc.lhdt.domain.Move;
...
import lhdt.admin.svc.lhdt.persistence.UserGroupMapper;
import lhdt.admin.svc.lhdt.service.UserGroupService;
import lhdt.admin.svc.lhdt.service.UserService;
...
public class UserGroupServiceImpl implements UserGroupService {
	...
	public List<UserGroup> getListUserGroup() {
		List<UserGroup> list = userGroupMapper.getListUserGroup();
		log.debug("<<.getListUserGroup - {}", list.size());
		return list;
	}
	...
	public List<UserGroupMenu> getListUserGroupMenu(UserGroupMenu userGroupMenu) {
		List<UserGroupMenu> list = userGroupMapper.getListUserGroupMenu(userGroupMenu);
		log.debug("<<.getListUserGroupMenu - {} {}", list.size(), userGroupMenu);
		return list;
	}
