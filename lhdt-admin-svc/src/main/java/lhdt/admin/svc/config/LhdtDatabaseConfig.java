...
@Slf4j
@Configuration
@MapperScan(value="lhdt.admin.svc.lhdt", annotationClass = LhdtConnMapper.class, sqlSessionFactoryRef = "lhdtSqlSessionFactory")
...
//	}
	...
	public SqlSessionFactory lhdtSqlSessionFactory(@Qualifier("lhdtDataSource") DataSource lhdtDataSource, ApplicationContext context) throws Exception{
		...
		//
		sqlSessionFactoryBean.setMapperLocations(context.getResources("classpath*:mybatis/admin/lhdt/**/*.xml"));
