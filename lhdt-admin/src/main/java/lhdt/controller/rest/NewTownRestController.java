...
public class NewTownRestController implements AuthorizationController {
	 ...
	 */
	@PostMapping
	public Map<String, Object> insert(HttpServletRequest request, @Valid @ModelAttribute NewTown newTown, BindingResult bindingResult) {
	...
	public Map<String, Object> update(HttpServletRequest request, @Valid NewTown newTown, BindingResult bindingResult) {
